...
5. _Download all **longtracker files** from **Github**, and add the directory containing them to the MATLAB paths as well (or just add them to the Bio-format toolbox folder)._
